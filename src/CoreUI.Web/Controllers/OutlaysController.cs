...
namespace CoreUI.Web.Controllers
{
    public class OutlaysController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Employee_Id,Project_Id,Client_Id,Date,NoteNumber,NoteValue,Description,File")] Outlays outlays, IFormFile Document)
        {
            GetSessions();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Employee_Id,Project_Id,Client_Id,Date,NoteNumber,NoteValue,Description,File")] Outlays outlays)
        {
            GetSessions();
