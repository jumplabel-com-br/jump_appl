        ...
        [
            {
                ...
                customize: function (doc) {
                    ...
                    /*
                    doc.content[1].table.body[2].forEach(function (h, item) {
                        h.fillColor = '#fff';
                        h.style = '#000';
                    ...
                    function docContentSplite(param1, param2, m0, m1, m2, m3, al, width, heigth, text) {
                    ...
                    docContentSplite(3, 0, 0, 30, 0, 0, 'left', 200, 100, '______________________________');
                    docContentSplite(4, 0, 0, 3, 0, 0, 'left', 200, 100, 'Assinatura Gestor Jump Label');
                    docContentSplite(5, 0, 0, 3, 0, 0, 'left', 200, 100, 'Nome:');
                    docContentSplite(6, 0, 0, 3, 0, 0, 'left', 200, 100, 'CPF:');

                    docContentSplite(7, 0, 0, 30, 0, 0, 'left', 200, 100, '______________________________');
                    docContentSplite(8, 0, 0, 3, 0, 0, 'left', 200, 100, 'Assinatura Consultor');
                    docContentSplite(9, 0, 0, 3, 0, 0, 'left', 200, 100, 'Nome:');
                    docContentSplite(10, 0, 0, 3, 0, 0, 'left', 200, 100, 'CPF:');
                },
